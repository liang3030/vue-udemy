  ...
  <section>
    ...
    <ul>
      <friend-contact v-for="friend in friends" :key="friend.id" :name="friend.name" :phone-number="friend.phone"
        :email-address="friend.email" :is-favorite="friend.isFavorite" :id="friend.id"
        @toggle-favorite="toggleFavoriteStatus" @delete="removeFriend"></friend-contact>
...
export default {
  ...
  methods: {
    ...
    addNewFriend(contact) {
      ...
      const newFriend = { id, ...contact, isFavorite: false };
